...
INSERT INTO tb_informe (id, tipo, dependencia, texto) VALUES
(1, 'T1', 'D1', 'PUESTA EN MARCHA'),
(2, 'T2', 'D11', 'REQUERIMIENTOS DEL HARDWARE Y SOFTWARE '),
(3, 'P1', 'D11', 'Para la utilización del Traductor se debe tener en cuenta lo siguiente: '),
(4, 'T3', 'D111', 'REQUISITOS DE HARDWARE: '),
(5, 'L1', 'D111', 'Computadora con mínimo 4 GB de RAM '),
(6, 'L1', 'D111', 'Espacio libre en el Disco de 500 MB'),
(7, 'T3', 'D112', 'REQUISITOS DE SOFTWARE: '),
(8, 'L1', 'D112', '  Sistema operativo Windows 7 o posterior, MacOS. '),
(9, 'L1', 'D112', 'Navegadores Chrome, Firefox, Microsoft Edge'),
(10, 'L1', 'D112', 'Lector de archivos PDF, como Acrobat Reader u otro similar'),
(11, 'L1', 'D112', '  Conexión a internet'),
(12, 'L1', 'D112', '  Los lenguajes de programación: PHP, HTML, JAVASCRIPT'),
(13, 'L1', 'D112', '  Servidor de datos: Mysql 5.7+ - MariaDB 10.4+'),
(14, 'L1', 'D112', 'Apache 2.4.35 VC15'),
(15, 'L1', 'D112', 'v  PHP 7.2+'),
(16, 'T1', 'D2', 'INSTALACIÓN'),
(17, 'T2', 'D21', '¿Quién puede hacer la instalación?'),
(18, 'P1', 'D211', 'Los perfiles que cumplen con la instalación son: un técnico en sistemas, un programador y un Analista-programador.'),
(19, 'P1', 'D211', 'Las locaciones adecuadas para la instalación, podrían ser en cualquier medio tecnológico que cumplan con los requerimientos; como los son Computador, Tablet o dispositivo móvil. Además, desde cualquier sala de cómputo, o simplemente desde la comodidad de su casa, si cuenta con los recursos para la instalación del traductor.'),
(20, 'T1', 'D3', 'RECOMENDACIONES'),
(21, 'P1', 'D31', 'Para evitar pérdidas por motivos mayores o catástrofes, es recomendable subir el software a un servidor web, donde se podrá alojar sin ningún problema y siempre estará disponible sin importar donde se encuentre.'),
(22, 'P1', 'D31', 'Constantemente el fluido eléctrico presenta fallas, es por esto que se recomienda usar una UPS, que se usa para alimentar a un equipo electrónico o eléctrico, Tiene un diseño interactivo, ahorradora de energía cuenta con auto reinicio cuando regresa la energía, protege su equipo de alti-bajos de energía y contra cortos circuitos. ... Protege tu equipo contra un apagón de energía.'),
(23, 'T1', 'D4', 'CONFIDENCIALIDAD, INTEGRIDAD Y DISPONIBILIDAD.'),
(24, 'P1', 'D41', 'No aplican, porque no se realiza ningún tipo de registro de los usuarios.'),
(25, 'T1', 'D5', 'COPIAS DE SEGURIDAD'),
(26, 'P1', 'D51', 'Estará alojado en el servidor de hosting, para que tenga el privilegio de la realización de las copias de seguridad, este servidor automáticamente las realizara. '),
...
(29, 'P1', 'D512', 'Esta parte es muy sencilla debido a que ya está alojada en un servidor web, si desea migrar a otro equipo, solo debe ingresar al servidor, iniciando sesión y podrá acceder automáticamente al traductor.'),
(30, 'P1', 'D512', 'Adicional a esto dejaremos una copia de la base de datos en el siguiente enlace:'),
(31, 'P1', 'D512', 'Esto con el fin de que tenga acceso a la base de datos, en caso tal, de que se presente alguna anomalía o perdida total de la información del software; '),
...
(41, 'P1', 'D81', 'La lengua del tucano ha perdido fuerza, y esto se debe a que muchos de los que pertenecen a la etnia, se han civilizado, y los que tienen un dominio de su propia lengua han venido falleciendo, dificultando la recolección de datos para seguir alimentando la base de datos. '),
(42, 'P1', 'D81', 'En cuanto a la programación y tecnologías, cada día van innovando, esto obliga a conocer diferentes formas de programar y conocer nuevas líneas de codificación, debilitando el proceso de mejoras del mismo.');
